	...
	*/
	class Page {
		...
		function fpage(){
			...
			$html[0] = "&nbsp;<span class='lbl search-span'> 共计 {$this->total} {$this->config["head"]} </span>&nbsp;";
		...
		private function pageList(){
			...
			/*当前页的信息 */
			if($this->pageNum > 1)
				$linkPage .= "<li class='active'><a href='{$this->uri}page={$page}'>{$this->page}</a></li>";
	...
	class Page2 {
		...
		function fpage(){
			...
			$fpage = '<div style="text-align:right; color:black; font:12px \'\5B8B\4F53\',san-serif;">';
			if(count($arr) < 1)
				$arr = array(0, 1,2,3,4,5,6,7);
