<?php 
	...
	$sql1 = "select * from menu where up_id={$_GET['id']} and id={$_GET['mid']}";
				...
				<div class="col-xs-12">
					<div class="tabbable">
						<ul class="nav nav-tabs" id="myTab">
							...
							<li class="active">
								<a href="pic_edit.php?id=<?php echo $_GET['id'] ?>"><?php echo $info['name'] ?>编辑</a>
							</li>
						</ul>
						<?php 
							if (isset($_GET['a'])&&$_GET['a']=='edit') {
								...
								// exit;
								if ($mes) {
									alertMes("修改成功","pic.php?id={$_GET['id']}");
								}else{
									alertMes("修改失败","pic_edit.php?id={$_GET['id']}&mid={$_GET['mid']}");
									exit;
								}
							}
						 ?>
						<div class="tab-content">
							<form action="pic_edit.php?id=<?php echo $_GET['id'] ?>&mid=<?php echo $_GET['mid'] ?>&a=edit" class="form-horizontal" role="form" method="post"enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="name" value="<?php echo $rows['name'] ?>" class="col-xs-10 col-sm-5">
									</div>
								</div>	
								<div class="form-group">
									<label class="col-sm-2 control-label no-padding-right" for="form-field-1" >菜单图标</label>
									<div class="col-sm-10">
